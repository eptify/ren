...
anyString : String | MultilineString | Tag | ImpliedString ;
anyDateTime : DateTime | Date | RelTime ; // RelDateTime | RelDate | RelTime ;
...
fragment Timezone : 'Z' | (SIGN TimeOfDay) ;
